 ...
 *   <img style={{display: "block"}} src="/img/adapters/astra-db.png" width="48" />
 *  </a>
 * </div>
 *
 * ## Installation
 *
 * ```bash npm2yarn2pnpm
 * npm install next-auth @auth/astra-db-adapter
 * ```
 *
 ...
 * ------------------------------------------------------------------------------
  import { JsonApiConfig } from ""@auth/astra-db-adapter/types"
