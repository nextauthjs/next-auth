 ...
 * This can either be done per route, or for a group of routes using middleware.
 *
 * First define your middleware as follows:
 * ```ts
 ...
 *
 * ```ts title="routes/root.route.ts"
 *
 * const rootRouter = Router()
 *
 * // This route is protected
 * rootRouter.get("/profile", ensureAuthenticated, (req, res) => {
 ...
 * ```
 * Then mount the router as follows:
 * ```ts title="app.ts"
 ...
 * protectedRouter.use(ensureAuthenticated) // All routes defined after this will be protected
 *
