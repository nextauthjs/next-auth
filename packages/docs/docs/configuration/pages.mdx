...
<iframe src="https://codesandbox.io/embed/next-auth-example-oauth-signin-2h6ej?fontsize=12&hidenavigation=1&moduleview=1&initialpath=%2Fauth%2Foauth-signin&module=/pages/auth/oauth-signin.jsx,/pages/api/auth/[...nextauth].js&theme=dark"
     style={{ width:'100%', height:'500px', border:'0',  borderRadius: '4px', overflow:'hidden' }}
     title="next-auth-example-oauth-signin"
...
<iframe src="https://codesandbox.io/embed/next-auth-example-email-signin-pyce6?fontsize=12&hidenavigation=1&initialpath=%2Fauth%2Femail-signin&module=/pages/auth/email-signin.jsx,/pages/api/auth/[...nextauth].js&theme=dark"
     style={{ width:'100%', height:'500px', border:'0',  borderRadius: '4px', overflow:'hidden' }}
     title="next-auth-example-email-signin"
     allow="accelerometer; ambient-light-sensor; camera; encrypted-media; geolocation; gyroscope; hid; microphone; midi; payment; usb; vr; xr-spatial-tracking"
     sandbox="allow-forms allow-modals allow-popups allow-presentation allow-same-origin allow-scripts"
   ></iframe>
...
<iframe src="https://codesandbox.io/embed/next-auth-example-pcc6k?autoresize=1&fontsize=12&hidenavigation=1&initialpath=%2Fauth%2Fcredential-signin&module=/pages/auth/credential-signin.jsx,/pages/api/auth/[...nextauth].js&theme=dark"
     style={{ width:'100%', height:'500px', border:'0',  borderRadius: '4px', overflow:'hidden' }}
