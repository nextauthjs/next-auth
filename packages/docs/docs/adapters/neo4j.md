...
This schema is adapter for use in Neo4J and is based upon our master [models](/adapters/models). Please check there for the node properties. Relationships have no properties.
