...
By using this provider we assume you comply with NetSuite's [Terms of Service](https://www.netsuite.com/portal/assets/pdf/terms_of_service.pdf) and [Privacy Policy](https://www.netsuite.com/portal/assets/pdf/privacy_policy.pdf).
