...
export async function signOut(
  ...
  const url = createActionURL("signout", protocol, headers, process.env, config.basePath)
...
export async function auth(
  ...
  const sessionUrl = createActionURL("session", protocol, req.headers, process.env, config.basePath)
