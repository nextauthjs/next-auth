...
Since version 3.2 Next Auth ships with TS type definitions colocated with the package. From that version on you no longer need to install `@types/next-auth`.

TypeScript support is a community effort. Please contribute pull-requests to improvement to the typings.
