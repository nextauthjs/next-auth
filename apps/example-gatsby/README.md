> NOTE: The example repository is maintained from a monorepo. The source code can be found here: https://github.com/nextauthjs/next-auth/tree/main/apps/gatsby-example. Pull Requests should be opened against https://github.com/nextauthjs/next-auth.
