...
- [Magic Links](/getting-started/providers/email-tutorial) (_Email Provider like Resend, Sendgrid, Nodemailer etc..._)
- [Credentials](/getting-started/providers/credentials-tutorial) (_Username and Password, Integrating with external APIs, etc..._)
