...
To enable social logins, choose an OAuth/OIDC provider from the list below, or if you don't see your provider, you can also create one. Have a look at our guide on [connecting a custom OAuth provider](/guides/configuring-oauth-providers#use-your-own-provider).
