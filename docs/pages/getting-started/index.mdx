...
- As for development, `AUTH_SECRET` is the only required environment variable.
...
You have configured Auth.js in your application!
...
- Learn more about auth concepts in the [concepts](/concepts) section. (Not just for Auth.js users!).
