...
<img align="right" src="/img/providers/github.svg" height="64" width="64" className="dark:hidden block" />
<img align="right" src="/img/providers/github-dark.svg" height="64" width="64" className="dark:block hidden" />
