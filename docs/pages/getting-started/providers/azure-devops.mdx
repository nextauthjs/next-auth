...
<Callout type="info">
  Azure DevOps OAuth 2.0 is still supported, but the Azure team is no longer
  investing in this model. They recommend you [migrate to Microsoft Entra ID
  OAuth](https://learn.microsoft.com/en-us/azure/devops/integrate/get-started/authentication/oauth?view=azure-devops#available-oauth-models).
</Callout>
