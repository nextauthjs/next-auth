...
If you wish to use Descope [Widgets](https://docs.descope.com/widgets) with NextAuth, you will have to wrap your NextAuth components with our Next.js SDK and `<AuthProvider>`. 
