...
<img align="right" src="/img/providers/boxyhq-saml.svg" height="64" width="64" className="dark:hidden block" />
<img align="right" src="/img/providers/boxyhq-saml-dark.svg" height="64" width="64" className="dark:block hidden" />
