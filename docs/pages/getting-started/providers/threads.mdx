...
<img align="right" src="/img/providers/threads.svg" height="64" width="64" className="dark:hidden block" />
<img align="right" src="/img/providers/threads-dark.svg" height="64" width="64" className="dark:block hidden" />
