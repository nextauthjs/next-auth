...
<img align="right" src="/img/providers/wikimedia.svg" height="64" width="64" className="dark:hidden block" />
<img align="right" src="/img/providers/wikimedia-dark.svg" height="64" width="64" className="dark:block hidden" />
