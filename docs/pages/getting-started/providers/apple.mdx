...
<img align="right" src="/img/providers/apple.svg" height="64" width="65" className="dark:hidden block" />
<img align="right" src="/img/providers/apple-dark.svg" height="64" width="65" className="dark:block hidden" />
