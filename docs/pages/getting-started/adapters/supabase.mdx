...
Add this adapter to your `./auth.ts` Auth.js configuration file.
...
Using the [NexthAuth.js Session callback](https://authjs.dev/docs/session-management) create the Supabase `access_token` and append it to the `session` object.
