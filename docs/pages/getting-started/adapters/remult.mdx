...
_(You are missing something, join [remult](https://remult.dev) and add yours.)_
...
Nothing about migrations ? No, it will be done the remult way, automatically 🎉. _[read more here](https://remult.dev/docs/migrations)_
