...
This is the raw SQL migration, for more details including an example MongoDB migration, check out the updated Prisma schemas at the [prisma adapter docs](/getting-started/adapters/prisma).
