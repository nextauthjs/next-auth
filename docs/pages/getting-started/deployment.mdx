...
You can see an Auth.js app being hosted via Docker at https://nextjs-docker-example.authjs.dev (see the [source code](https://github.com/nextauthjs/next-auth-example)). Below is an example `Dockerfile` for a Next.js application running Auth.js.
