...
fields in your [OAuth provider](/guides/configuring-oauth#use-your-own-provider)'s [`profile()`](/reference/core/providers#profile) callback.
...
returning them in the [OAuth provider](/guides/configuring-oauth#use-your-own-provider)'s [`account()`](/reference/core/providers#account) callback.
