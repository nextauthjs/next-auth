  ...
  <section className="flex justify-center w-full px-8 xl:px-0 flex-col lg:flex-row self-center items-center lg:items-start gap-6 max-w-7xl pt-12 pb-24 sm:py-32 lg:py-56">
    <div className="flex-col flex justify-start gap-10 lg:py-8 mx-8">
      ...
      <div className="text-lg flex-col flex gap-2 items-center">
        <div className="flex self-stretch justify-between text-base  dark:bg-neutral-900 bg-slate-50 p-4 ring-1 ring-slate-300 dark:ring-gray-700 rounded-md">
          ...
          <a
            ...
            target="_blank"
            className="flex gap-2 text-violet-600"
          >
            Use Clerk ›
          </a>
        </div>
        <span className="text-xs text-slate-400 font-semibold">Sponsored</span>
      </div>
    </div>
    <HeroCode>
      <HeroCode.Next>
