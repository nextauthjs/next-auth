    ...
    <div className="flex flex-col items-center gap-16">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <a
          href="https://github.com/nextauthjs/next-auth"
          target="_blank"
          className="p-4 text-center rounded-lg font-semibold flex items-center gap-2 text-black dark:text-white transition bg-[#FFF4] dark:bg-[#FFFFFF03] border border-neutral-200 dark:border-neutral-800 backdrop-blur-sm"
        >
