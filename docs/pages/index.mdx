...
<div className="relative overflow-hidden w-full h-full flex flex-col">
  <section className="flex justify-center w-full px-8 lg:px-4 flex-col lg:flex-row self-center items-center lg:items-start gap-6 max-w-7xl pt-12 pb-24 sm:py-32 lg:py-56">
    <div className="flex-col flex justify-start gap-10 mx-8">
