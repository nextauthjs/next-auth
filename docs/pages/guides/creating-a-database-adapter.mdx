...
1. Configure the monorepo to help us maintain the package
   ...
   - Add the Adapter to our documentation generator
     [file](https://github.com/nextauthjs/next-auth/blob/9ac0f98b73d6e52a8cb3a859f203915b994d6d19/docs/scripts/generate-manifest.mjs#L68)
   - Add a (preferably `.svg`) logo to [this
     directory](https://github.com/nextauthjs/next-auth/tree/main/docs/static/img/adapters)
