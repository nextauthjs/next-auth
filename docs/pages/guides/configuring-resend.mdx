...
If you haven't, create an `.env.local` file as explained in the [installation section](/installation) and add the following Resend API key variable.
...
import ResendSuccess from "../../public/img/magic-links/signin-success.png"

<Screenshot src={ResendSuccess} alt="Resend Authentication Success" />
