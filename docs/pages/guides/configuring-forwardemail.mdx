...
<Callout type="info">
  This tutorial uses Forward Email as the Passwordless email provider and Next.js as
...
<Callout>
  You can customize the contents of this email and modify some additional Forward Email
  parameters. For more details, check out our [Forward Email provider](/getting-started/providers/forwardemail) docs page.
</Callout>
