...
import { Callout, Pre, Code as NXCode, Steps } from "nextra/components"
...
`
        ...
        <p className="mt-6 leading-7 first:mt-0">
          ...
          configuration. You’ll have to import the{" "}
          <NXCode>{providerName}</NXCode> provider from the package and pass it
          to the <NXCode>providers</NXCode> array we setup earlier in the
          Auth.js config file:
        </p>
        <SetupCode
        ...
        <p className="mt-6 leading-7 first:mt-0">
          Next, we can add a signin button somewhere in your application like
          the Navbar. It will trigger Auth.js sign in when clicked.
        </p>
        <SignInCode
          providerId={providerId}
          providerName={providerName}
        ...
        <p className="mt-6 leading-7 first:mt-0">
          Click the “Sign in with {providerName}" button and if all went well,
          you should be redirected to {providerName} and once authenticated,
          redirected back to the app!
        </p>
        <Callout>
          You can build your own Signin, Signout, etc. pages to match the style
          of your application, check out{" "}
