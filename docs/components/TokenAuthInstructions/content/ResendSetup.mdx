...
To configure Resend, you'll just need to define your API key as an environment variable. If you use this exact name, `AUTH_RESEND_KEY`, then the Resend provider will automatically pick it up and your provider array in the Auth.js config can be simplified, see the example below.
