...
You can [also use a different name for the environment variables](/concepts/environment-variables#oauth-variables) if needed, but then you’ll need to pass them to the provider manually.
