---
title: Creating a framework integration
---

The core functionalities of Auth.js - `@auth/core` - are built on top of the Web Standard [Request](https://developer.mozilla.org/en-US/docs/Web/API/Request)/[Response](https://developer.mozilla.org/en-US/docs/Web/API/Response) mental model, and therefore are framework-agnostic. For each framework, we provide an integration layer that allows you to use the authentication features in a way that is specific to the framework. See the [list of integrations](./reference#integrations) that are currently available.
...
This will copy all the files from our official template at `./packages/frameworks-template` to new directory under `packages/` with all the required files, and rename the placeholders to the name of the framework you provided.
...
- Miscellaneous:
  ...
  - Add a redirect rule for the documentation page. See [this example](https://github.com/nextauthjs/next-auth/blob/e34d7ad5f2eb6129a5d313cbcfb593eb94d59857/docs/vercel.json#L75-L79) of a redirect rule for Express
  - Add an entry to our manifest generation. See [this example](https://github.com/nextauthjs/next-auth/blob/e34d7ad5f2eb6129a5d313cbcfb593eb94d59857/docs/scripts/generate-manifest.mjs#L58-L65) of a manifest entry for Express.
  - Add an entry to the PR labeler. See [this example](https://github.com/nextauthjs/next-auth/blob/46264fb42af4c3ef7137a5694875eaa1309462ea/.github/pr-labeler.yml#L30) of a labeler entry for SvelteKit.
