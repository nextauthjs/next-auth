...
| `@auth/solid-start`    | Released (experimental). See [docs](/reference/sveltekit) Community package: [`@solid-mediakit/auth`](https://www.npmjs.com/package/@solid-mediakit/auth)                              |
