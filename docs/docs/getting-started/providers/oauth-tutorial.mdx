...
NextAuth.js is fully customizable - [our guides section](/guides) teaches you how to set it up to handle auth in different ways. All the possible configuration options are [listed here](/reference/core/module.index#authconfig).
:::
...
Auth.js is fully customizable - [our guides section](/guides) teaches you how to set it up to handle auth in different ways. All the possible configuration options are [listed here](/reference/core/module.index#authconfig).
:::
