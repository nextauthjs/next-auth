...
:::info
Auth.js is extremely customizable, [our guides section](/guides) will teach you how you can set it up to handle auth in different ways. All the possible configuration options are [listed here](/reference/configuration/auth-config).
:::
...
:::info
You can create your own Sign In page instead of using the default one from Auth.js. You can learn how to do so in our [dedicated guide for it](https://authjs.dev/guides/basics/pages).
:::
