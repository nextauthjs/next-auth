...
export interface BattleNetProviderOptions {
  clientId: string;
  clientSecret: string;
  region: string;
}

const BattleNetProviderFactory: OAuth2Provider<BattleNetProviderOptions> = (options) => {
...
export default BattleNetProviderFactory;