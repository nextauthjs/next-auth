...
import webhookSignin from "../lib/signin/webhook";
...
export default async (req, res, options, done) => {
  ...
  if (type === "oauth") {
    ...
    console.log("[signin.js] Inside email.post");
    if (!adapter) {
    ...
    await webhookSignin("phoneNumber", "123", provider, options);
    console.log("This is where the webhook ends after the link gets here");
  } else {
