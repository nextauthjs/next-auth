...
export function setOptions({
  ...
  if (disableSessionEventBroadcast) {
    __NEXTAUTH.disableSessionEventBroadcast = disableSessionEventBroadcast
  }
  if (disableLogoutEventBroadcast) {
    __NEXTAUTH.disableLogoutEventBroadcast = disableLogoutEventBroadcast
  }
}
