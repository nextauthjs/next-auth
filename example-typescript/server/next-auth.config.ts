 ...
 *
 * If you wish, you can put these in a `.env` to separate your environment
...
import nextAuthFunctions from "./next-auth.functions";
import { IOptions, IFunctions } from "../../";
...
export default (): Promise<IOptions> => {
  ...
  return nextAuthFunctions().then((functions: IFunctions) => {
    return new Promise<IOptions>(
      (resolve) => {
