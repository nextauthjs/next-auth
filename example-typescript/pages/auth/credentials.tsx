...
import { NextAuth, INextAuthSessionData } from "../../../client";
import { NextContext } from "next";

interface ICredentialsPropsType {
  session: Partial<INextAuthSessionData<{ email: string }>>;
  email: string;
  password: string;
}

interface ICredentialsStateType {
  session: Partial<INextAuthSessionData<{ email: string }>>;
  email: string;
  password: string;
}
...
export default class extends React.Component<
  ICredentialsPropsType,
  ICredentialsStateType
> {
