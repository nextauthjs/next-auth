...
NextAuth.js includes built-in support for signing in with Apple, Auth0, Google, Battle.net, Box, Bungie, AWS Cognito, Discord, Facebook, FusionAuth, GitHub, GitLab, Google, Open ID Identity Server, Mixer, Okta, Slack, Spotify, Twitch, Twitter and Yandex.
