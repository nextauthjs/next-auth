...
In 2020, NextAuth.js was rebuilt from the ground up with in-built support for Serverless Framework, MySQL, PostgreSQL, MongoDB, JSON Web Tokens and over a dozen authentication providers.
