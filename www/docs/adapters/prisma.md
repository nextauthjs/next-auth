...
```
npm install --save @prisma/client @next-auth/prisma-adapter
...
To create the database based on the Prisma schema (i.e. create tables and columns) run the following command:
